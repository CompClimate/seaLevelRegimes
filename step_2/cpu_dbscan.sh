...
#SBATCH -o dumps/dbscan/cpu/clim_slog_%j.out
#SBATCH -e dumps/dbscan/cpu/clim_slog_%j.err
...
do
    ...
    OUTPUT_FILE="${OUTPUT_DIR}/eps${EPSILON}_ms${MIN_SAMPLES}/emb_$(printf '%02d' "$MEMBER")th_ensemble_md${MD}_nn${NN}.npz"
