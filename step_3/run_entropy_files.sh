...
PYTHON_SCRIPT="/home/djeutsch/Projects/seaLevelRegimes/step_3/entropy_files.py" 
...
LOGFILE="/home/djeutsch/Projects/seaLevelRegimes/step_3/dumps/python/ent_nclust_NC${NUM_CLUST}.log"

echo "Running export entropy Python script for: num_cluster=${NUM_CLUST}"
