...
PYTHON_SCRIPT="/home/djeutsch/Projects/ODRI/step_3_entropy/entropy_files.py" 
...
LOGFILE="/home/djeutsch/Projects/ODRI/step_3_entropy/dumps/python/ent_nclust_NC${NUM_CLUST}.log"

echo "Running export entropy Python script for:"
